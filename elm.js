...
var author$project$Posts$sortPosts = function (posts) {
	return elm$core$List$reverse(
		A2(
...
var author$project$Posts$viewPostItem = function (post) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var author$project$Posts$viewPostListContent = function (posts) {
	return elm$core$List$isEmpty(posts) ? _List_fromArray(
		[
			elm$html$Html$text('No posts yet!')
		]) : A2(elm$core$List$map, author$project$Posts$viewPostItem, posts);
};
var author$project$Posts$viewPostList = function (postList) {
	return elm$core$Result$Ok(
		A2(
			author$project$Page$layout,
			postList.ak,
			author$project$Posts$viewPostListContent(
				author$project$Posts$sortPosts(postList.ci))));
};
var elm$json$Json$Decode$value = _Json_decodeValue;
var author$project$Posts$main = A2(author$project$Elmstatic$layout, author$project$Elmstatic$decodePostList, author$project$Posts$viewPostList);
